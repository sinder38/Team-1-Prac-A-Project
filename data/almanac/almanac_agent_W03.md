...
- NFP (Nonfarm Payrolls) on Friday 5 June is the dominant market event this week.
- Net: slight bearish lean from June midterm year context. No strong specific week pattern.

SECTOR SIGNALS:
- Technology (XLK): seasonal LONG window (Mar–Jul). Still active. Supports Nasdaq.
- Banking (XLF): seasonal SHORT (May–Jul). Headwind for financials continues.
- Gold/XAU: seasonal SHORT (mid-May–Jun). Contradicts gold near all-time highs.
- Materials (XLB): seasonal SHORT (May–Oct). 6-month window continues.
