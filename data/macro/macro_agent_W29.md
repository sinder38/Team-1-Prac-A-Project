Macro Agent Output — Week of 17 July — Source: R4
...
- 2-year yield: 4.130% 10-year yield: 4.550% 30-year yield: 5.080%
- Yield curve: normal. 10-year direction this week: falling

COMMODITIES & DOLLAR (Yfinance):

- WTI Crude Oil: 80.2, weekly change +12.31%, direction: rising
- Gold: 4007, weekly change -2.38%, direction: falling
- DXY (Dollar): 100.74, weekly change -0.23%, direction: falling
