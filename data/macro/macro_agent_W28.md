Macro Agent Output — Week of 10 July — Source: R4
...
- 2-year yield: 4.210% 10-year yield: 4.560% 30-year yield: 5.060%
- Yield curve: normal. 10-year direction this week: rising

COMMODITIES & DOLLAR (Yfinance):

- WTI Crude Oil: 71.56, weekly change +4.18%, direction: rising
- Gold: 4108.5, weekly change -0.10%, direction: falling
- DXY (Dollar): 100.96, weekly change +0.10%, direction: rising
