# Week 05 Market Report (2026)

**Week ended:** Friday, June 19, 2026  
...
**In plain words:** All 3 available index readings finished higher. NDX led with a up 2.60% move, while SPX was the weakest at up 0.93%.
...
|------|----------------|----------------------|
| 1 | Technology | **Up 3.59%** |
| 2 | Industrials | **Up 2.68%** |
| 3 | Utilities (power, water) | **Up 0.52%** |
| 4 | Consumer discretionary (cars, hotels, shopping) | Up 0.48% |
| 5 | Financials (banks, insurance) | Up 0.43% |
| 6 | Materials (chemicals, metals, etc.) | Down 0.71% |
| 7 | Communication (phones, media, ads) | Down 1.97% |
| 8 | Health care | Down 2.87% |
| 9 | Consumer staples (food, toothpaste, etc.) | **Down 2.94%** |
| 10 | Real estate | **Down 3.31%** |
| 11 | Energy (oil & gas companies) | **Down 6.57%** |

### Best 3 this week
1. **Technology** — up 3.59%. Move based on software, chips, and hardware via XLK.
2. **Industrials** — up 2.68%. Move based on manufacturers, transport, and machinery via XLI.
3. **Utilities (power, water)** — up 0.52%. Move based on regulated power and water utilities via XLU.

### Worst 3 this week
1. **Energy (oil & gas companies)** — down 6.57%. Move based on oil and gas producers via XLE.
2. **Real estate** — down 3.31%. Move based on property and REIT stocks via XLRE.
3. **Consumer staples (food, toothpaste, etc.)** — down 2.94%. Move based on defensive food and household products via XLP.

**In plain words:** Sector breadth showed a mixed market: 5 of 11 available sectors finished green. Technology led at up 3.59%, while Energy (oil & gas companies) lagged at down 6.57%.
