...
Usual:
+ The sprint goal is written clearly in [sprint_goal_W28.md](./sprint_goal_W28.md)
+ The acceptance criteria are documented in acceptance_criteria_W28.md.
...
New:
+ 2/4 agents tested fully (again)
+ Everyone on the team participates in the sprint's work
+ The pipeline runs successfully end-to-end
+ The delta engine is merged
+ Macro engine graph generation is merged
+ Backend web server and frontend are integrated and merged
