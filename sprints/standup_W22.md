...
**Done**
- Completed README.md, LICENSE.md, CONTRIBUTING.md, and CODE_OF_CONDUCT.md.
- Created presentation slides.
- Coordinated team workflow and ensured members understood their responsibilities.
- Reviewed submitted pull requests and requested changes where required.
- Organised project content into appropriate folders.

**Doing**
- Following up with team members to ensure assigned tasks are completed.
...
- Project requirements are occasionally unclear or conflicting.
...
**Blocked**
- Missing updates from some team members.
- Communication challenges caused by inactivity from certain members.
...
**Done**
- Completed almanac_agent_W02.md.
- Analysed cycle context, May vital statistics, Memorial Day patterns, sector signals, bias, and thesis.
...
**Blocked**
- Almanac PDF link on the course website could not be accessed directly.
...
**Contributors:** Minghao, Saiko, Jayson

**Done**
- Synthesised outputs from multiple LLMs to determine overall market sentiment.
...
**What Worked Well**
- The team successfully avoided automation bias despite unanimous bullish AI outputs.
- Human Score analysis incorporated additional macro risks to produce a more balanced outlook.
- The team adapted successfully to the cancellation of the live presentation by producing a standalone presentation deck with detailed speaker notes.

**What Needs Improvement**
- Confusion regarding prediction windows delayed progress.
- Inconsistent file naming conventions increased integration workload.
...
**Done**
- Reviewed pull requests and requested changes where necessary.
...
- Created a project Git tag at completion.
...
- Human Score revisions remain pending.
...
Overall sprint progress remained on track. Core deliverables from Almanac, Macro, Technical Analysis, LLM Synthesis, Human Score, Data & Evidence, GitHub Integration, and QA were completed. Remaining work focused on presentation preparation, evidence verification, pull request reviews, and final project submission.
