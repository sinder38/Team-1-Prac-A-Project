...
The local development pipeline uses Ollama with `llama3.2:1b`. The automated CI pipeline uses Nemotron 3 Super, Tencent HY3, Gemma 4 26B A4B, and Laguna M.1.
