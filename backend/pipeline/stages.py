...
from llm.openrouter import OpenRouterAgent, _row
from agents.macro.macro_agent import MacroAgent
from pipeline.config import LLMModelEntry, PipelineConfig
...
def run_delta(
    ...
    if hasattr(config.artifacts, "save_md") and config.artifacts.save_md:
