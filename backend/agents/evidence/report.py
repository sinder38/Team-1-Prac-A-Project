...
"""
    ...
    def _render_screenshot_rows(self, snapshot: EvidenceSnapshot) -> str:
        ...
        if any(sector.weekly_change is not None for sector in snapshot.sectors):
            rows.append(
    ...
    def _plain_words_sectors(self, sectors: list) -> str:
        ...
        if not available:
            return (
                "Yahoo Finance sector ETF data was not available for this completed week, "
                "so no sector heatmap was generated."
            )
